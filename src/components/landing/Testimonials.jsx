...
const Testimonials = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-10 w-64 h-64 bg-violet-200/30 rounded-full blur-2xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20 space-y-4">
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-violet-100 shadow-bold">
          ...
          <p className="text-lg mx-auto max-w-2xl text-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            <div
              className="group relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-md p-8
            border border-gray-100 hover:border-violet-200 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-300 hover:-translate-y-1"
              key={index}
            >
              {/* Quote icon */}
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <div className="absolute inset-0  rounded-full bg-gradient-to-br from-violet-500 to-purple-600 blur opacity-20"></div>
                  <img
              ...
              <div className="absolute inset-0  bg-gradient-to-br from-violet-50/0 to-purple-50/0 opacity-20 group-hover:from-violet-50/50 group-hover:to-purple-50/30 transition-all duration-300 rounded-3xl -z-10"></div>
            </div>
          ))}
        </div>
