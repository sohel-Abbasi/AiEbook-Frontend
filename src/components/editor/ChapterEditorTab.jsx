...
const ChapterEditorTab = ({
  ...
  const formMarkdown = (content) => {
    return (
      content
        ...
        .replace(/(<li.*<\/li>)/gs, '<ol class="my-4 ml-4">$1</ol>')
        // Paragraphs
        .split("\n\n")
        .map((paragraph) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="border-b border-r-gray-100 bg-white">
        <div className="px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-0 justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1 md:text-base">
                Editing:{" "}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 text-sm rounded-lg transition-colors text-gray-600 hover:bg-gray-100"
              >
            ...
            <div className="space-y-6 h-full flex flex-col">
              ...
              <div>
                <InputField
                  ...
                  className="block w-full pl-3 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-100 focus:border-violet-500 transition-all bg-white text-gray-900 placeholder-gray-400 outline-none text-xl font-semibold"
                />
              </div>
              {/* Editor/Preview Area */}
                  ...
                  <div className="h-full border border-gray-200 rounded-lg overflow-y-auto">
                    ...
                    <div className="p-8">
                      ...
                      <div
                        ...
                        style={{
                          fontFamily:
                            'Charter, Georgia, serif, "Times New Roman", Times, serif',
                          lineHeight: "1.7",
                        }}
                        dangerouslySetInnerHTML={{
                          __html: currentChapter.content
                            ? formMarkdown(currentChapter.content)
                            : '<p class="text-gray-400 italic">No content yet. Start writing to generate content.</p>',
                        }}
                      />
                    </div>
                  </div>
