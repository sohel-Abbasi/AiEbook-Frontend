...
const SortableItem = ({
  ...
  return (
    ...
    >
      <button
        className={`flex-1 flex items-center p-3 text-left rounded-l-lg transition-colors ${selectedChapterIndex === index ? "bg-violet-50/50 text-violet-800 font-semibold" : "text-slate-600 hover:bg-slate-100"}`}
...
const ChapterSidebar = ({
  ...
  return (
    <aside className="w-80 flex flex-col h-full border-r border-slate-200 bg-white">
      <div className="p-4 border-b border-slate-200">
        ...
        <h2
          className="text-base text-slate-800 font-semibold mt-4 truncate"
          title={book.title}
        >
          {book.title}
        </h2>
